...
///
/// These helpers live in the app layer because the concrete config types
/// (`VisualisationConfig`, `TransformerConfig`, etc.) are app/Visualiser
/// concerns — `RunKit` treats them as opaque `Data?`.
///
extension RunItem {
